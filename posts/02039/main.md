...
<h2>有限MDPの定式化</h2>
<ul>
 	<li>離散状態の集合[latex]\\mathcal{S}= \\{s_i | i=1,2,\\dots,N \\}[/latex]を考える
<ul>
 	<li>状態が連続の場合は離散化
<ul>
 	...
 	<li>制御出力
<ul>
 	<li>何種類かから選択[latex]\\mathcal{A} = \\{ a_j | j = 1,2,\\dots,M \\}[/latex]</li>
 	<li>連続系の[latex]\\mathcal{U}[/latex]から何種類か必要なものを選んだイメージ</li>
</ul>
</li>
 	<li>状態遷移
<ul>
 	<li>[latex]s' \\sim P(s' | s,a)[/latex]</li>
</ul>
</li>
</ul>
