...
<h2>名前解決</h2>
<ul>
 	<li>IPアドレスとホスト名はどう変換されているか？
<ul>
 	<li>DNSサーバ
<ul>
 	<li>ネットワーク上にあり、IPアドレスとホストを管理している</li>
 	<li>例えば ping www.yahoo.co.jpと打つと、計算機はDNSサーバに聞きにいく
<ul>
 	<li>どのDNSサーバに聞くかは、通常/etc/resolv.confに書いてあるが、だんだん使わない方向に行っているので注意</li>
</ul>
</li>
</ul>
</li>
 	<li>/etc/hosts 静的にIPアドレスとホストを対応付けたい時はここに書く</li>
</ul>
</li>
</ul>
<!--nextpage-->
