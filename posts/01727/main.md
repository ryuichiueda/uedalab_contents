...
<ul>
 	...
 	<li>[latex]bel(\\boldsymbol{x}|\\boldsymbol{z}) = \\frac{p(\\boldsymbol{z}|\\boldsymbol{x})bel(\\boldsymbol{x})}{\\int_{\\boldsymbol{x}'}p(\\boldsymbol{z}|\\boldsymbol{x}')bel(\\boldsymbol{x}')} \\\\
