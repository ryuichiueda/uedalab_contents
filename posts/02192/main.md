...
<!--nextpage-->
<h2>デバイスファイルからの読み出し</h2>
<ul>
 	<li>catすると寿司を表示する無駄機能の実装
<ul>
 	<li>今度はcopy_to_userでカーネルからユーザランドへ文字を送ります</li>
</ul>
</li>
</ul>
...
<span style="color: #ffffff;">     char sushi[] = {0xF0,0x9F,0x8D,0xA3,0x0A};</span>
