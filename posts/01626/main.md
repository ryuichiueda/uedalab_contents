...
=\\boldsymbol{\\hat{x}}_{t-1} + \\frac{\\partial f(\\boldsymbol{x},\\boldsymbol{u}_t)}{\\partial\\boldsymbol{x}}|_{t-1}(\\boldsymbol{x} -\\boldsymbol{\\hat{x}}_{t-1}) + \\boldsymbol{\\varepsilon}_t [/latex]</li>
 	<li></li>
</ul>
