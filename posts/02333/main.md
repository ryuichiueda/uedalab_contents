...
<h2>既存の著作物の利用</h2>
<ul>
 	<li>ライセンスの仕組みを理解して責任を持って積極的に行う
<ul>
 	<li>勉強以外の目的ではなるべく自分で作らない</li>
 	<li>コードを書くなということではない。目的を最短時間で終わらせる。</li>
</ul>
</li>
 	<li>自分でコードを書くときの基準
<ul>
...
<ul>
 	<li>だいたい難しいのでコードを読む技術があるのが望ましい</li>
</ul>
</li>
 	<li>衝動・勉強・同人活動
<ul>
 	<li>それもまたよし。ただし、付加価値が無く終わることがないよう実験的に</li>
</ul>
</li>
</ul>
</li>
