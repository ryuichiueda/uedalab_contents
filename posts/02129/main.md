...
<pre class="p1"><span class="s1" style="color: #ffffff;">obj-m:= myled.o</span>

<span class="s1" style="color: #ffffff;">myled.ko: myled.c</span>
<span class="s1" style="color: #ffffff;"> make -C /usr/src/linux M=`pwd` V=1 modules</span>
<span class="s1" style="color: #ffffff;">clean:</span>
<span class="s1" style="color: #ffffff;"> make -C /usr/src/linux M=`pwd` V=1 clean</span></pre>
<ul>
 	<li>このディレクトリで次のようにmakeする</li>
</ul>
