...
<ul>
 	<li>
<pre class="p1"><span class="s1">[1]+<span class="Apple-converted-space">  </span>停止<span class="Apple-converted-space">                  </span>seq 1 10000000000 | awk '$1%2'</span></pre>
</li>
</ul>
</li>
 	<li>
...
<ul>
 	<li>
<pre class="p1"><span class="s1">[2]+<span class="Apple-converted-space">  </span>停止<span class="Apple-converted-space">                  </span>find / | grep --color=auto aho</span></pre>
</li>
</ul>
</li>
 	<li>
...
<ul>
 	<li>
<pre class="p1"><span class="s1">[1]-<span class="Apple-converted-space">  </span>停止<span class="Apple-converted-space">                  </span>seq 1 10000000000 | awk '$1%2'</span>

<span class="s1">[2]+<span class="Apple-converted-space">  </span>停止<span class="Apple-converted-space">                  </span>find / | grep --color=auto aho</span></pre>
</li>
</ul>
</li>
</ol>
