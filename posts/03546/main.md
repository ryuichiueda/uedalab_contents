...
<ul>
 	<li><span style="font-size: 15px; font-weight: 300;">（</span><span style="font-size: 15px;">上田隆一: "移動ロボットのためのROSパッケージの紹介と実機への導入方法", 計測と制御, Vol.57 No.10, pp.715-720, 2018.の韓国語訳）</span></li>
</ul>
</li>
</ul>
</div>
...
<ul>
 	<li>上田隆一, 加藤祐介: ARツールを用いたオドメトリのキャリブレーションシステム, 日本機械学会 ロボティクス・メカトロニクス 講演会, 1A1-Q04, 広島, 2019. (to appear)</li>
 	<li>平間翔大, 上田隆一, 中川友紀子: ソフトクラスタリングを用いたばら積み唐揚げの検出方法に関する検討, 日本機械学会 ロボティクス・メカトロニクス 講演会, 2PI-I04, 広島, 2019. (to appear)</li>
 	<li>佐藤大亮, 齊藤篤志, 上田隆一: 加速度情報を用いたEpisode on Filter Particle, 日本機械学会 ロボティクス・メカトロニクス 講演会, 1A1-L06, 広島, 2019. (to appear)</li>
</ul>
<h2 id="2018">2018</h2>
<h3>Review article</h3>
<ul>
