...
<ul>
 	<li><span style="color: #0000ff;">$ kill -KILL 12345 <span style="color: #333333;">    #SIGKILL（後述）をPIDが12345のプロセスに</span></span></li>
 	<li>$ kill 12345              #SIGTERMをPIDが12345のプロセスに</li>
</ul>
</li>
 	<li>発展: trapコマンドを使うとシェルスクリプト内でシグナルを
補足して割り込み処理が書ける</li>
</ul>
<!--nextpage-->
<h2>主なシグナル</h2>
...
<ul>
 	...
 	<li class="p1">使われ方
<ul>
 	<li class="p1">端末が切れるとセッションリーダに<span class="s3">SIGHUP </span>が飛ぶ
<ul>
 	<li class="p1">セッションリーダー: セッションIDの持ち主</li>
</ul>
</li>
 	<li class="p1">セッションリーダーがいなくなるとカーネルから
