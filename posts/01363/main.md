...
<ul>
 	...
 	<li>制御出力: [latex]\\Delta_t[/latex]で[latex]x[/latex]が[latex]x + \\Delta_t + /latex]（雑音）で変化
<ul>
 	<li>雑音は標準偏差[latex]\\delta_t[/latex]でガウス分布に従う</li>
</ul>
</li>
</ul>
</li>
...
<ul>
 	...
 	<li>[latex]p(\\boldsymbol{x} | \\boldsymbol{x}_{t-1},\\Delta_t) =\\frac{1}{\\sqrt{2\\pi \\sigma_{t-1}^2}}\\exp \\{-\\frac{(x-\\hat{x}_{t-1})^2}{2\\sigma_{t-1}^2}\\}[/latex]</li>
</ul>
</li>
</ul>
