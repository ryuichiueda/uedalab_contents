...
<ul>
 	...
 	<li>SoC（system on a chip。CPU＋いろんな機能を付加したチップ）の型番の調べ方</li>
</ul>
</li>
</ul>
<pre><span style="color: #ffffff;">$ cat /proc/cpuinfo | grep -i hardware</span>
<span style="color: #ffffff;">Hardware : BCM2709</span></pre>
