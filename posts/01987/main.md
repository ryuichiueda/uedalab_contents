...
<pre class="p1"><span style="color: #ffffff;"><span class="s1">$</span><span class="s2"> echo aaa &gt; ~/tmp/file1    #元のところにファイルを作っておきましょう
 	...
 	<li>アンマウント</li>
 	<li>
<pre class="p1"><span style="color: #ffffff;"><span class="s1">$</span><span class="s2"> sudo umount ~/tmp</span></span>
<span style="color: #ffffff;"><span class="s1">$</span><span class="s3"> ls ~/tmp/ #元に戻る</span></span>
<span class="s2" style="color: #ffffff;">file1</span></pre>
</li>
</ul>
</li>
</ul>
...
<span style="color: #ffffff;">/dev/sdc1         59871340     53064   56753856    1% /home/ueda/tmp</span></pre>
