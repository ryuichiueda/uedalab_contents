...
<ul>
 	...
 	<li>[latex]P(s' | s,a) = [/latex]<span style="color: #ff0000;">[latex]\\mathcal{P}^a_{ss'}[/latex]<span style="color: #333333;">と表記しましょう</span></span></li>
</ul>
</li>
</ul>
<!--nextpage-->
...
<ul>
 	<li>状態遷移の評価
<ul>
 	<li>[latex]R(s,a,s') = [/latex]<span style="color: #ff0000;">[latex]\\mathcal{R}^a_{ss'}[/latex]</span></li>
</ul>
</li>
</ul>
