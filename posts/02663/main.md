...
In the following movie, the gmapping node works on the note pc and the robot sends the scan data and its odometry through ROS. We have also verified that the gmapping node can work on Raspberry Pi 3 with a standalone fashion. 
