...
<ul>
 	...
 	<li>rospy.Publisherを作って定期的にデータを投げる</li>
</ul>
...
<ul>
 	...
 	<li>型はInt32</li>
 	<li>データを受け取ったときにcbという関数で処理（コールバック関数）</li>
</ul>
</li>
</ul>
<pre class="p1"><span class="s1" style="color: #ffffff;">#!/usr/bin/env python</span>
...
<span class="s1" style="color: #ffffff;"><span class="Apple-converted-space">    </span>rospy.loginfo(message.data)</span>
