...
<ul>
 	...
 	<li>センサ値と地図の比較
<ul>
 	<li>あるセルの0か1に入れ替えた地図[latex]m_{\\text{m_i=0}},m_{\\text{m_i=1}}[/latex]二つに対してこれまでの[latex]P(z_t|m_{m_i=0}, x_t)\\ (t=1,2,\\dots,N)[/latex]を対数にして合計した値[latex]P(z_t|m_{m_i=1}, x_t)\\ (t=1,2,\\dots,N)[/latex]を対数にして合計したとを比較
<ul>
 	<li>[latex]m'[/latex]: 計算対象のセルを0か1にした二つの地図のうちの1つを表す</li>
 	<li>0と1のうち、上記の合計値の大きい方を選ぶ</li>
</ul>
</li>
</ul>
</li>
