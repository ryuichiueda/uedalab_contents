...
<h2><!--nextpage--></h2>
<h2>TD（temporal difference）学習</h2>
<ul>
 	<li>行動した時に次の式で価値を更新
<ul>
 	<li>[latex]V(s) \\longleftarrow (1-a)V(s) + \\alpha[r + \\gamma V(s')][/latex]
<ul>
 	<li>[latex]\\alpha[/latex]: ステップサイズパラメータと呼ばれる
[latex]g[/latex]: 割引率（移動等の問題の場合は1で考えておいて大丈夫です）</li>
</ul>
</li>
 	<li>何回も上の式で価値を更新すると価値反復の時と同様、収束</li>
