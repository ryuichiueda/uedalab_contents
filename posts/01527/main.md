...
<table width="687" style="border: 1px solid #FFF">
<tbody>
<tr>
<td width="160" style="border: 1px solid #FFF"></td>
<td width="193" style="border: 1px solid #FFF">用途</td>
<td width="147" style="border: 1px solid #FFF">電源OFF後

のデータ</td>
<td width="200">動作の速さ</td>
</tr>
<tr>
<td width="200" style="border: 1px solid #FFF">フラッシュメモリ</td>
<td width="193" style="border: 1px solid #FFF">プログラム</td>
<td width="147" style="border: 1px solid #FFF">残る</td>
<td width="188" style="border: 1px solid #FFF">遅い</td>
</tr>
<tr>
<td width="160" style="border: 1px solid #FFF">EEPROM</td>
<td width="193" style="border: 1px solid #FFF">保存用データ</td>
<td width="147" style="border: 1px solid #FFF">残る</td>
<td width="188" style="border: 1px solid #FFF">遅い</td>
</tr>
<tr>
<td width="160" style="border: 1px solid #FFF">SRAM</td>
<td width="193" style="border: 1px solid #FFF">計算中のデータ等</td>
<td width="147" style="border: 1px solid #FFF">消える</td>
<td width="188" style="border: 1px solid #FFF">速い</td>
</tr>
</tbody>
</table>
<h2><!--nextpage--></h2>
