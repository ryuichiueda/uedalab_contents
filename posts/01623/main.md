...
=f(\\boldsymbol{\\hat{x}}_{t-1},\\boldsymbol{u}_t) + \\frac{\\partial\\boldsymbol{x}_{t-1},\\boldsymbol{u}_t)}{\\partial\\boldsymbol{x}}(\\boldsymbol{x} -\\boldsymbol{\\hat{x}}_{t-1}) + \\boldsymbol{\\varepsilon}_t [/latex]</li>
 	<li></li>
</ul>
