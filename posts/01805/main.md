...
<ul>
 	<li><span style="color: #3366ff;">$ ps aux</span></li>
 	<li>項目の意味
<ul>
 	<li>
<p class="p1"><span class="s1">USER: ユーザ</span></p>
</li>
 	<li>
<p class="p1"><span class="s1">PID: プロセスID</span></p>
</li>
 	<li>
<p class="p1"><span class="s2">%</span><span class="s1">CPU: CPU使用率,</span></p>
</li>
 	<li>
<p class="p1"><span class="s2">%$</span><span class="s1">MEM: メモリ使用率</span></p>
</li>
 	<li>
<p class="p1"><span class="s1">VSZ: 仮想メモリのサイズ, </span></p>
<p class="p1"><span class="s1">RSS: 使用している物理メモリ量, TTY: 端末, STAT: プロセスの状態,</span></p>
<p class="p1"><span class="s1">START: 起動した時間, TIME: 使ったCPU時間, COMMAND: コマンド名、カーネルスレッド名</span></p>
</li>
</ul>
</li>
</ul>
