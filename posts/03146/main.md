# 確率ロボティクス2017第2回
03146 <h1 style="font-size: 250%;">確率ロボティクス</h1>
<h2>第2回</h2>
上田 隆一
...
<ul>
 	...
 	<li><a href="https://github.com/ryuichiueda/probrobo_practice/blob/master/state_equations/with_noise.ipynb">コードの例</a></li>
</ul>
</li>
</ul>
<!--nextpage-->
...
<!--nextpage-->
<h2>[latex]bel[/latex]の例</h2>
<ul>
 	<li>先ほどのコードで最後に描いた絵: [latex]bel_{10}[/latex]とみなせる</li>
 	<li>ロボットが雑音つきの状態方程式を知っていると計算可能</li>
 	<li>Monte Carlo Localizationの一部</li>
</ul>
<a href="https://lab.ueda.tech/wp-content/uploads/2017/09/bel.png"><img class="wp-image-3200 alignnone" src="https://lab.ueda.tech/wp-content/uploads/2017/09/bel.png" alt="" width="241" height="228" /></a>
<h2> <!--nextpage--></h2>
<h2>まとめ</h2>
<ul>
 	<li>キーワード
<ul>
 	<li>状態、エージェント、エージェントの出力、状態遷移、状態方程式、[latex]bel[/latex]
<ul>
 	<li>「ロボットが動く」ということのモデル化</li>
</ul>
</li>
</ul>
</li>
...
<ul>
 	<li>実環境を動くロボットの宿命</li>
 	<li>ロボットが雑音を考慮することで[latex]bel[/latex]を計算できる</li>
</ul>
</li>
</ul>
