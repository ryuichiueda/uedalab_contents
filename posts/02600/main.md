# 確率ロボティクス2016第11回
02600 <h1 style="font-size: 250%;">確率ロボティクス</h1>
<h2>第11回</h2>
上田 隆一
...
（0が「壁がない」、1が「壁がある」）</li>
 	...
 	<li>センサ値と地図の比較（収束するまで繰り返し）
<ul>
 	<li>各セルの値を0か1に入れ替えた地図[latex]m_{m_i=0},m_{m_i=1}[/latex]二つに対して次の値を比較
<ul>
 	<li>[latex]\\sum_{t=1}^T \\log P(z_t|m_{m_i=0}, x_t)[/latex]</li>
 	<li>[latex]\\sum_{t=1}^T \\log P(z_t|m_{m_i=1}, x_t)[/latex]</li>
</ul>
<ul>
