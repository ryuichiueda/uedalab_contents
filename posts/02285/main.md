...
<ul>
 	<li>コピーレフトの考え方をライセンス化したもの<a href="https://lab.ueda.asia/wp-content/uploads/2016/11/GPLv3_Logo.png"><img class="alignright size-medium wp-image-2284" src="https://lab.ueda.asia/wp-content/uploads/2016/11/GPLv3_Logo-300x149.png" alt="gplv3_logo" width="300" height="149" /></a></li>
 	<li>ストールマンの立ち上げたFSF（Free Software Foundation）が策定</li>
 	<li>基本的なルール
<ul>
 	<li>GPLで頒布されたプログラム（コードやバイナリ）について、ユーザは実行、再配布、改変、調査できる権利を有する</li>
