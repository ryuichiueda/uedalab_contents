...
<p class="p1"><span class="s1" style="color: #0000ff;">$ sleep 1000000</span></p>
 	...
 	<li><span style="color: #0000ff;"><span style="color: #0000ff;">Ctrl+Z
</span></span>
<pre class="p1"><span class="s1">^Z</span>

<span class="s1">[1]+<span class="Apple-converted-space">  </span>停止<span class="Apple-converted-space">                  </span>sleep 1000000</span></pre>
</li>
</ol>
</li>
</ul>
