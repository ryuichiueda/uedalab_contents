...
<ul>
 	<li>今、[latex]bel[/latex]が、次の式で表されているとする
<ul>
 	...
 	<li>次のようなセンサ入力がありました。
<ul>
 	<li>[latex]z[/latex]: ロボットの位置[latex]x[/latex]を直接計測した値
<ul>
 	<li>（センサ値とロボットの位置が同じ軸にある特殊なパターン）</li>
</ul>
</li>
 	<li>[latex]z[/latex]には次の分布に従う雑音が生じます
<ul>
 	<li>[latex]p(z|x) = \\frac{1}{\\sqrt{2\\pi \\zeta^2}}\\exp \\{-\\frac{(z-x)^2}{2\\zeta^2}\\}[/latex]</li>
</ul>
</li>
</ul>
</li>
