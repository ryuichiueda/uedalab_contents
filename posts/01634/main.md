...
<ul>
 	<li>[latex] f(\\boldsymbol{x},\\boldsymbol{u}) = f(\\boldsymbol{x}_{t-1},\\boldsymbol{u}) + \\frac{\\partial f(\\boldsymbol{x},\\boldsymbol{u})}{\\partial\\boldsymbol{x}}\\big|_{\\boldsymbol{x}_{t-1}}[/latex]
 	<li></li>
</ul>
