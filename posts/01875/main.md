...
<ul>
 	<li>[latex]bel(\\boldsymbol{x} | \\boldsymbol{x}_{0:t-1},\\boldsymbol{u}_{1:t}) = \\int_\\mathcal{X} p(\\boldsymbol{x} | \\boldsymbol{x}',\\boldsymbol{u}_t )bel_{t-1}(\\boldsymbol{x}') d\\boldsymbol{x}'[/latex]</li>
