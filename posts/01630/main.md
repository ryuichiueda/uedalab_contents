...
=\\boldsymbol{\\hat{x}}_{t-1} + \\frac{\\partial f(\\boldsymbol{x},\\boldsymbol{u}_t)}{\\partial\\boldsymbol{x}}\\Big|_{\\boldsymbol{\\hat{x}}_{t-1}}\\boldsymbol{u}_t + \\boldsymbol{\\varepsilon}_t [/latex]</li>
 	<li></li>
</ul>
