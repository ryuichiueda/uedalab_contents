...
<ul>
 	...
 	<li>Raspberry Piの場合
<ul>
 	<li><a href="https://www.raspberrypi.org/documentation/hardware/raspberrypi/bcm2836/README.md" target="_blank">Raspberry Piのページのbcm2836に関するページ</a>で調査</li>
 	<li>Raspberry Pi 3のbcm2837も同じ</li>
</ul>
</li>
</ul>
<pre><span style="color: #ffffff;">$ cat /proc/cpuinfo | head</span>
<span style="color: #ffffff;">processor : 0</span>
<span style="color: #ffffff;">model name : ARMv7 Processor rev 4 (v7l)</span>
<span style="color: #ffffff;">BogoMIPS : 38.40</span>
<span style="color: #ffffff;">Features : half thumb fastmult vfp edsp neon vfpv3 tls vfpv4 idiva idivt vfpd32 lpae evtstrm crc32 </span>
<span style="color: #ffffff;">CPU implementer : 0x41</span>
<span style="color: #ffffff;">CPU architecture: 7</span>
<span style="color: #ffffff;">CPU variant : 0x0</span>
<span style="color: #ffffff;">CPU part : 0xd03</span>
<span style="color: #ffffff;">CPU revision : 4</span></pre>
