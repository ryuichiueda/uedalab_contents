...
<ul>
 	...
 	<li>操作で把握しましょう
<ol>
 	<li><span class="s1" style="color: #0000ff;">$ sleep 1000000 | cat | cat      <span style="color: #333333;"> #後ろのcatは特に意味はない</span></span><span style="font-size: 15px; color: #333333;">     </span>
</li>
 	<li>
<p class="p1"><span style="color: #0000ff;">Ctrl+Z</span></p>
</li>
 	<li><span style="color: #0000ff;"> <span class="s1">$ sleep 200000 | sleep 200000</span></span>
</li>
