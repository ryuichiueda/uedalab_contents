...
<ul>
 	...
 	<li><span style="color: #ff0000;">終端状態の価値[latex]V(s)\\qquad s \\in \\mathcal{S}_\\text{f}[/latex]を拡張して、状態空間全体の関数: [latex]V^*: \\mathcal{S} \\to \\Re[/latex]とする</span></li>
</ul>
<!--nextpage-->
<h2>価値の計算</h2>
<ul>
 	<li>終端状態近くで計算してみましょう</li>
 	<li>[latex]</li>
</ul>
