...
<ul>
 	<li>[latex]J(s_{0:T},a_{1:T}) =\\mathcal{R}^{a_1}_{s_0s_1} +\\mathcal{R}^{a_2}_{s_1s_2} +\\mathcal{R}^{a_3}_{s_2s_3} \\\\
\\qquad\\qquad\\qquad\\qquad+ \\dots +\\mathcal{R}^{a_T}_{s_{T-1}s_T} + V(s_T)\\\\
= \\sum_{t=1}^T \\mathcal{R}^{a_t}_{s_{t-1}s_t} + V(s_T)  [/latex]</li>
</ul>
</li>
</ul>
