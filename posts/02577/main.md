...
<ul>
 	<li>計算機で設定しなければならないこと</li>
 	<li>外にパケットを出すときにどのルータに向けてパケットを送るか</li>
 	<li>どのIPアドレスが外のものなのか</li>
 	<li>（DHCPを使っていると自動で設定されているので気がつかない）</li>
</ul>
</li>
...
<ul>
 	...
 	<li>下の例の読み方
<ul>
 	<li>255.255.254.0でマスクをかけた時のIPアドレスが一致すればeth0から直接データを相手のIPアドレスに送る</li>
 	<li>それ以外の場合はeth0から「デフォルトゲートウェイ」
<p class="p1"><span class="s1">133.242.186.1に送る</span></p>
</li>
</ul>
</li>
</ul>
