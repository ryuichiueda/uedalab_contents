...
（~/tmpの中でやると一度ディレクトリの外に出て入り直す必要があるので~/から）
<ol>
 	<li>
<p class="p1"><span style="color: #0000ff;"><span class="s1">$</span><span class="s2"> echo aaa &gt; ~/tmp/file1    #元のところにファイルを作っておきましょう</span></span></p>
</li>
 	<li>
<p class="p1"><span style="color: #0000ff;"><span class="s1">$</span><span class="s3"> ls ~/tmp
</span></span><span class="s2" style="color: #0000ff;">file1</span></p>
</li>
 	<li>
<p class="p1"><span style="color: #0000ff;"><span class="s1">$</span><span class="s2"> sudo mount /dev/sdc1 ./</span></span></p>
</li>
 	<li>
<p class="p1"><span style="color: #0000ff;"><span class="s1">$</span><span class="s2"> sudo mount /dev/sdc1 ~/tmp   #マウント</span></span></p>
</li>
 	<li>
<p class="p1"><span class="s1">$</span><span class="s3"><span style="color: #0000ff;"> ls ~/tmp/             #~/tmpが差しているディレクトリが変わる</span>
</span><span class="s2">lost+found</span></p>
</li>
</ol>
</li>
</ul>
