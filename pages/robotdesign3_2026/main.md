# ロボット設計製作論実習3（2026年度知能コース）

## コース選択のためのガイダンス

### なにをするのか

- CRANE-X7というマニピュレータをROS 2やその他自分が使いたいソフトウェアで動かします
...
自身のデータの保全については教員やTAでは責任がとれないので、各自防衛してください。

- いずれか
    - ROS 2の動くネイティブ環境の準備（Ubuntu 24.04など）
    - ROS 2を用いないときは、ロボットを動作させるためのソフトウェアのセットアップ
        - 仮想マシン等では処理能力不足になる可能性があります
    - 自身のWindows PCが起動しない/吹き飛んだときの準備
        - BitLockerの回復キーのメモ or BitLockerの解除
        - ノートPCのバックアップ
...
- 教材
    - ROS 2セットアップの動画
        - これだけなので、基本はTAの助けを借りて自分でなんでも勉強していく必要があります。
- 機材
    - CRANE-X7: 7軸マニピュレータ
    - RealSense: 深度カメラ
- ソフトウェア
    - CRANE-X7公式のソフトウェア
    - 先輩のソフトウェア
        - 1から作ろうとせず、ライセンスにしたがってコピーして進化させるのが望ましいです
...
指示待ちになりがちな人は放置される可能性があるので、ちょっと危険かもしれません。これまで1チームだけですがそういうケースがありました。
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/v-kNXKOB5Vw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


- 8班


<iframe width="560" height="315" src="https://www.youtube.com/embed/gYiEyViJK8k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/FqgcY9u_59M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/plgapQKrkck" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/5Ge4IksQk-o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/vijc1l0GHZ8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/1xodhp0x2yE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/pqUIFGcDyzs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
